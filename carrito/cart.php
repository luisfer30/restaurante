              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="product-remove">Retirar</th>
                  </tr>
                </thead>
                <tbody>
                <?php  
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="row mb-5">
              ...
              <div class="col-md-6">
                <a href="index.php" class="btn btn-outline-primary btn-sm btn-block">Continuar Comprando</a>
              </div>
            </div>
            <div class="row">
              <div class="col-md-12">
                <label class="text-black h4" for="coupon">Cupon de Descuento</label>
                <p>Si tienes un cupon de Descuento usalo aqui.</p>
              </div>
